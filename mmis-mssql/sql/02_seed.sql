/* ============================================================================
   MMIS — генерация фейковых данных на весь семестр.
   Всё генерируется процедурно (а не вручную), поэтому объём данных большой:
...
INSERT mmis.Institutes(Name) VALUES
 (N'Институт информационных технологий и коммуникаций'),
 (N'Институт математики и естественных наук'),
...
SELECT d.Name, i.Id
FROM (VALUES
  (N'Кафедра информационной безопасности', N'Институт информационных технологий и коммуникаций'),
  (N'Кафедра программной инженерии',        N'Институт информационных технологий и коммуникаций'),
  (N'Кафедра вычислительной техники',       N'Институт информационных технологий и коммуникаций'),
  (N'Кафедра математического анализа',      N'Институт математики и естественных наук'),
  (N'Кафедра физики',                       N'Институт математики и естественных наук'),
  (N'Кафедра химии',                        N'Институт математики и естественных наук'),
  (N'Кафедра экономической теории',         N'Институт экономики и управления'),
  (N'Кафедра менеджмента',                  N'Институт экономики и управления'),
  (N'Кафедра финансов и кредита',           N'Институт экономики и управления')
) d(Name, InstName)
...
INSERT mmis.Subjects(Name) VALUES
 (N'Математический анализ'),(N'Линейная алгебра'),(N'Дискретная математика'),
 (N'Программирование'),(N'Алгоритмы и структуры данных'),(N'Базы данных'),
 (N'Операционные системы'),(N'Компьютерные сети'),(N'Веб-разработка'),
 (N'Информационная безопасность'),(N'Теория вероятностей'),(N'Физика'),
 (N'Философия'),(N'История России'),(N'Иностранный язык'),
 (N'Экономическая теория'),(N'Менеджмент'),(N'Маркетинг'),
 (N'Бухгалтерский учёт'),(N'Финансы'),(N'Статистика'),
 (N'Объектно-ориентированное программирование'),(N'Машинное обучение'),
 (N'Архитектура ЭВМ'),(N'Математическая логика'),(N'Численные методы'),
 (N'Теория автоматов'),(N'Физическая культура');
...
JOIN (VALUES
  (N'Институт информационных технологий и коммуникаций', N'ИТ'),
  (N'Институт математики и естественных наук',          N'МЕ'),
  (N'Институт экономики и управления',                  N'ЭУ')
